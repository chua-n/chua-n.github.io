...
| 遍历算法 |                            示意图                            |
| :------: | :----------------------------------------------------------: |
| 先序遍历 | ![先序遍历](https://figure-bed.chua-n.com/notebook/DSA/先序遍历.jpg) |
| 中序遍历 | ![中序遍历](https://figure-bed.chua-n.com/notebook/DSA/中序遍历.jpg) |
| 后序遍历 | ![后序遍历](https://figure-bed.chua-n.com/notebook/DSA/后序遍历.jpg) |

### 1.2 BFS型

通常即**层次遍历**，其示意图如下：

<img src="https://figure-bed.chua-n.com/notebook/DSA/层次遍历.jpg" alt="层次遍历" style="zoom:67%;" />
...
<img src="https://figure-bed.chua-n.com/notebook/DSA/迭代版先序遍历.jpg" alt="迭代版先序遍历" style="zoom:67%;" />
...
> - 版本1和版本2的思路示意：
>
>   <img src="https://figure-bed.chua-n.com/notebook/DSA/迭代版中序遍历.jpg" alt="迭代版中序遍历" style="zoom:67%;" />
...
> 无须辅助栈，辅助空间仅O(1)，就地算法。
>
> <img src="https://figure-bed.chua-n.com/notebook/DSA/迭代版中序遍历-O(1).jpg" alt="迭代版中序遍历-O(1)" style="zoom:67%;" />
...
<img src="https://figure-bed.chua-n.com/notebook/DSA/迭代版后序遍历.jpg" alt="迭代版后序遍历" style="zoom:67%;" />
...
|           条件           |                             图示                             |
| :----------------------: | :----------------------------------------------------------: |
|    [先序\|后序]+中序     | ![[先序or后序]+中序](https://figure-bed.chua-n.com/notebook/DSA/[先序or后序]+中序.png) |
| [先序 + 后序] × 真二叉树 | ![[先序+后序]×真](https://figure-bed.chua-n.com/notebook/DSA/[先序+后序]×真.png) |
