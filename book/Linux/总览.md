...
![1](https://figure-bed.chua-n.com/notebook/杂技/Linux/1.png)
...
<img src="https://figure-bed.chua-n.com/notebook/杂技/Linux/2.png" style="zoom:67%;" />
...
- 文件系统管理：
  ...
  - Linux 服务器所访问的所有硬盘都必须格式化成表 1-1 所列文件系统类型中的一种；
    ...
    <img src="https://figure-bed.chua-n.com/notebook/杂技/Linux/3.png" style="zoom:67%;" />
...
3. GNOME 桌面：GNOME(the GNU Network Object Model Environment, GNU 网络对象模型环境)，现已成为许多 Linux 发行版默认的桌面环境
    ...
    ![](https://figure-bed.chua-n.com/notebook/杂技/Linux/4.png)

4. Unity 桌面：其宗旨是为工作站、平板电脑以及移动设备提供一致的桌面体验，Ubuntu 即为 Unity 桌面

    ![](https://figure-bed.chua-n.com/notebook/杂技/Linux/5.png)
...
<img src="https://figure-bed.chua-n.com/notebook/杂技/Linux/6.png" style="zoom:67%;" />
...
<img src="https://figure-bed.chua-n.com/notebook/杂技/Linux/image-20221206214204345.png" alt="image-20221206214204345" style="zoom:67%;" />
...
![](https://figure-bed.chua-n.com/notebook/杂技/Linux/7.png)
...
<img src="https://figure-bed.chua-n.com/notebook/杂技/Linux/image-20221206181451421.png" alt="image-20221206181451421" style="zoom:80%;" />
...
![](https://figure-bed.chua-n.com/notebook/杂技/Linux/8.png)
...
<img src="https://figure-bed.chua-n.com/notebook/杂技/Linux/9.png" style="zoom:67%;" />

将命令列表的形式用圆括号括住，则构成了**进程列表**。进程列表的不同之处在于它会生成一个子 shell 来执行对应的命令：

<img src="https://figure-bed.chua-n.com/notebook/杂技/Linux/10.png" style="zoom:67%;" />
...
- 临时修改：要将某目录添加到现有 `PATH` 变量中，只需使用 `echo` 引用原来的 `PATH` 值，然后添加新目录即可，但注意这种修改在退出 shell 或重启系统之后会失效
  ...
  <img src="https://figure-bed.chua-n.com/notebook/杂技/Linux/11.png" style="zoom:67%;" />
