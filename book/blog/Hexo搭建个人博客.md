...
![](https://figure-bed.chua-n.com/blog/hexo搭博客/hexo-default.jpeg)
...
效果如下：
![](https://figure-bed.chua-n.com/blog/hexo搭博客/hexo-written.jpeg)
...
![](https://figure-bed.chua-n.com/blog/hexo搭博客/next.jpeg)
...
-   新建一篇文章进行测试：
    ...
    效果如下：![](https://figure-bed.chua-n.com/blog/hexo搭博客/test-math.png)
...
![](https://figure-bed.chua-n.com/blog/hexo搭博客/update-gitee-pages.png)

即可在书写 markdown 博客时通过链接格式`http://username.gitee.io/gitee_pages_repo_name/path_to_the_image`引用这张图片。对于我刚刚上传的这张图片，其链接为`https://chua-n.gitee.io/figure-bed/blog/avatar.png`，我在这里的 markdown 语句引用示意一下，显示如下![](https://figure-bed.chua-n.com/blog/avatar.png)
