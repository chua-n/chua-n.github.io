...
- web页面
    ...
    ![36](https://figure-bed.chua-n.com/notebook/JavaWeb/SpringMVC/36.png)
...
3. 编写文件上传代码
    ...
    - 结果演示
        ...
        - 预备文件：C:\Users\admin\Desktop\xq\abc.txt
            ...
            ![37](https://figure-bed.chua-n.com/notebook/JavaWeb/SpringMVC/37.png)

        - 浏览器输入

            ![38](https://figure-bed.chua-n.com/notebook/JavaWeb/SpringMVC/38.png)

        - 控制台输出

            ![39](https://figure-bed.chua-n.com/notebook/JavaWeb/SpringMVC/39.png)

        - 服务器接收并保存的文件

            ![40](https://figure-bed.chua-n.com/notebook/JavaWeb/SpringMVC/40.png)
