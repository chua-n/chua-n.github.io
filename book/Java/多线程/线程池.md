...
![img](https://figure-bed.chua-n.com/notebook/Java/54.png)
...
| `boolean isTerminated()`                                     | true if all tasks have completed following shut down. <br />要想返回true，必须先执行`shutdown` 或`shutdownNow`方法。 |
