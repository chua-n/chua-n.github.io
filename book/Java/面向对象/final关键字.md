...
有些程序员认为，除非有足够的理由使用多态性，否则应该将所有的方法都声明为final。事实上，在C++和C#中，如果没有特别地说明，所有的方法都不使用多态性。这两种做法可能都有些偏激，我们提但在设计类层次时，要仔细地思考应该将哪些方法和类声明为final。
...
final类中的所有方法自动地成为final方法，字段则不受影响。
