...
<img src="https://figure-bed.chua-n.com/notebook/Java/33.png" alt="33" style="zoom:67%;" />
...
使用**局部内部类**时，通常还可以再进一步。假如只想创建这个类的一个对象，甚至不需要为类指定名字，这样一个类被称为**匿名内部类**（anonymous inner class）。
