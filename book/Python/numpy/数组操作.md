...
2. 涉及到“增维”操作时，可以在一个切片操作中利用`newaxis` 关键字：
    ...
    ![](https://figure-bed.chua-n.com/notebook/Python/303.png)
...
- 注意，索引操作中重复的索引会导致一些出乎意料的结果产生:
    ...
    ![](https://figure-bed.chua-n.com/notebook/Python/304.png)

## 3. 通用函数

Python 的默认实现（被称作 CPython）处理起某些操作时非常慢，一部分原因是该语言的动态性和解释性。

![](https://figure-bed.chua-n.com/notebook/Python/305.png)

![](https://figure-bed.chua-n.com/notebook/Python/306.png)
...
![](https://figure-bed.chua-n.com/notebook/Python/307.png)

![](https://figure-bed.chua-n.com/notebook/Python/308.png)
...
![](https://figure-bed.chua-n.com/notebook/Python/311.png)
...
- 通用函数的out参数
    ...
    ![](https://figure-bed.chua-n.com/notebook/Python/309.png)

- 这个特性也可以被用作数组视图

    ![](https://figure-bed.chua-n.com/notebook/Python/310.png)
...
![](https://figure-bed.chua-n.com/notebook/Python/316.png)
...
![](https://figure-bed.chua-n.com/notebook/Python/317.png)
...
![](https://figure-bed.chua-n.com/notebook/Python/315.png)
...
| 一维                                                 | 二维                                                 | 三维                                                 |
| ---------------------------------------------------- | ---------------------------------------------------- | ---------------------------------------------------- |
| ![](https://figure-bed.chua-n.com/notebook/Python/312.png) | ![](https://figure-bed.chua-n.com/notebook/Python/313.png) | ![](https://figure-bed.chua-n.com/notebook/Python/314.png) |
...
![](https://figure-bed.chua-n.com/notebook/Python/318.png)
