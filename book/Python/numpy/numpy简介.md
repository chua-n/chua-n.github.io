...
2. 但是这种类型灵活性也指出了一个事实：Python 变量不仅是它们的值，还包括了关于值的类型的一些额外信息。
    ...
    - 例如，当我们在Python中定义一个整型，例如x=10000 时，x 并不是一个“原生”整型，而是一个指针，指向一C语言的复合结构体，结构体里包含了一些值：
        ...
        ![](https://figure-bed.chua-n.com/Python/297.png)

        ![](https://figure-bed.chua-n.com/Python/298.png)
...
| 示例                                                 | 说明                                               |
| ---------------------------------------------------- | -------------------------------------------------- |
| ![](https://figure-bed.chua-n.com/Python/299.png) | 整型在这里被转换为浮点型                           |
| ![](https://figure-bed.chua-n.com/Python/300.png) | 如果希望明确设置数组的数据类型，可以用dtype 关键字 |
| ![](https://figure-bed.chua-n.com/Python/301.png) | 内层的列表被当作二维数组的行                       |
...
- 或者用相关的NumPy对象来指定
    ...
    ![](https://figure-bed.chua-n.com/Python/302.png)
