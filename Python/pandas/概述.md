...
![](../../resources/images/notebooks/Python/323.png)

![](../../resources/images/notebooks/Python/324.png)
...
4. 通过 `NumPy` 二维数组创建
    ...
    ![](../../resources/images/notebooks/Python/325.png)

5. 通过 `NumPy` 结构化数组创建

    ![](../../resources/images/notebooks/Python/326.png)
