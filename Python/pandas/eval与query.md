...
![445](../../resources/images/notebooks/Python/445.png)
...
![](../../resources/images/notebooks/Python/446.png)

这尤其适合处理大型数组。Pandas的`eval()`和`query()`工具就是基于Numexpr实现的。

Pandas的`eval()`函数用字符串代数式实现了`DataFrame`的高性能运算：

![](../../resources/images/notebooks/Python/447.png)

![](../../resources/images/notebooks/Python/448.png)

![](../../resources/images/notebooks/Python/449.png)
...
![](../../resources/images/notebooks/Python/450.png)

- 使用`DataFrame.eval()`新增列

    ![](../../resources/images/notebooks/Python/451.png)

    ![](../../resources/images/notebooks/Python/452.png)

- `DataFrame.eval()`使用局部变量

    ![](../../resources/images/notebooks/Python/453.png)
...
![](../../resources/images/notebooks/Python/454.png)

- 这是一个用`DataFrame`列创建的代数式，但是不能用`DataFrame.eval()`语法。此时，对于这种过滤运算，你可以用`query()`方法：

    ![](../../resources/images/notebooks/Python/455.png)
