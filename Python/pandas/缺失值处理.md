...
- `None`：Python 对象类型的缺失值
    ...
    ![](../../resources/images/notebooks/Python/344.png)
...
- `NaN`：数值类型的缺失值
    ...
    ![](../../resources/images/notebooks/Python/345.png)

    ![](../../resources/images/notebooks/Python/346.png)

    ![](../../resources/images/notebooks/Python/347.png)

- Pandas 中 `NaN` 与 `None` 的差异：Pandas 把 NaN 和 None 看成是可以等价交换的，在适当的时候会将两者进行替换：

    ![](../../resources/images/notebooks/Python/348.png)

- Pandas 中不同类型缺失值的转换规则

    > 再次提醒：Pandas 中字符串类型通常是用 `object` 类型存储的。

    ![](../../resources/images/notebooks/Python/349.png)
...
- 对于 `dropna()`方法：
    ...
    -   可以通过 `thresh` 参数设置行或列中非缺失值的最小数量
        ...
        | 图片                                                                                             | 图片                                                                                                                                | 图片                                                                                      |
        | ------------------------------------------------------------------------------------------------ | ----------------------------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------- |
        | ![NaN ](../../resources/images/notebooks/Python/350.png)                                         | ![df . dropna() ](../../resources/images/notebooks/Python/351.png)                                                                  | ![image-20220121130343578](../../resources/images/notebooks/Python/352.png)               |
        | ![df[3] -  nan  NaN  4.6  2 Nan  5 Nan  6 Nan ](../../resources/images/notebooks/Python/353.png) | ![• . sump Jp ](../../resources/images/notebooks/Python/354.png)<br />![1.9  3.6 ](../../resources/images/notebooks/Python/355.png) | ![In[22]: thresh=3)  Outt22J:  1 5 NaN ](../../resources/images/notebooks/Python/356.png) |
...
- 对于 `fillna()`方法：
    ...
    -   注意，假如从前往后填充时，需要填充的缺失值前面没有值，那以它填充后仍然是缺失值
        ...
        | 图片                                                                        | 图片                                                 | 图片                                                 | 图片                                                 |
        | --------------------------------------------------------------------------- | ---------------------------------------------------- | ---------------------------------------------------- | ---------------------------------------------------- |
        | ![image-20220121130616010](../../resources/images/notebooks/Python/357.png) | ![](../../resources/images/notebooks/Python/358.png) | ![](../../resources/images/notebooks/Python/359.png) | ![](../../resources/images/notebooks/Python/360.png) |
        | ![](../../resources/images/notebooks/Python/361.png)                        | ![](../../resources/images/notebooks/Python/362.png) |                                                      |                                                      |
