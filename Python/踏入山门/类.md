...
![](https://chua-n.gitee.io/blog-images/notebooks/Python/71.png)

给实例绑定属性的方法是通过实例变量，或者通过 `self` 变量：

![](https://chua-n.gitee.io/blog-images/notebooks/Python/72.png)
...
- 相同名称的实例属性将屏蔽掉类属性；但将实例属性删除后可访问对应的类属性。
    ...
    ![](https://chua-n.gitee.io/blog-images/notebooks/Python/73.png)
...
![](https://chua-n.gitee.io/blog-images/notebooks/Python/70.png)
...
![](https://chua-n.gitee.io/blog-images/notebooks/Python/233.png)
...
1. 创建子类的实例时，Python 首先需要完成的任务是给父类的所有属性赋值。
    ...
    ![](https://chua-n.gitee.io/blog-images/notebooks/Python/74.png)
...
3. 可以通过`__new__()`方法创建一个未初始化的实例。
    ...
    | 示例                                                         | 说明                                                         |
    | ------------------------------------------------------------ | ------------------------------------------------------------ |
    | ![](https://chua-n.gitee.io/blog-images/notebooks/Python/234.png)         | 一个类的示例                                                 |
    | ![](https://chua-n.gitee.io/blog-images/notebooks/Python/235-1.png)<br />![](https://chua-n.gitee.io/blog-images/notebooks/Python/235-2.png) | 不调用`__init__()`方法来创建这个Data实例  <br />可见这个Data实例的属性还不存在 |
    | ![](https://chua-n.gitee.io/blog-images/notebooks/Python/236.png)         | 需手动初始化实例的属性                                       |
...
| ![](https://chua-n.gitee.io/blog-images/notebooks/Python/237-1.png)<br />![](https://chua-n.gitee.io/blog-images/notebooks/Python/237-2.png) | ![](https://chua-n.gitee.io/blog-images/notebooks/Python/238.png) | ![](https://chua-n.gitee.io/blog-images/notebooks/Python/239.png) | ![](https://chua-n.gitee.io/blog-images/notebooks/Python/240.png) | ![](https://chua-n.gitee.io/blog-images/notebooks/Python/241-1.png)<br />![](https://chua-n.gitee.io/blog-images/notebooks/Python/241-2.png) |
| ------------------------------------------------------------ | ---------------------------------------------------- | ---------------------------------------------------- | ---------------------------------------------------- | ------------------------------------------------------------ |
