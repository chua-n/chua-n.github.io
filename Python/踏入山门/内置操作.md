...
![](https://chua-n.gitee.io/blog-images/notebooks/Python/7.png)
...
1. 查找某模块定义的名称：其返回一个排序过的字符串列表
    ...
    ![](https://chua-n.gitee.io/blog-images/notebooks/Python/8.png)

2. 若无参数，`dir()`列出你当前定义的名称：

    ![](https://chua-n.gitee.io/blog-images/notebooks/Python/9.png)

3. 注意：`dir()`不会列出内置函数和变量的名称，如果你想要这些，它们都定义在标准模块 `builtins` 中：

    ![](https://chua-n.gitee.io/blog-images/notebooks/Python/10.png)
