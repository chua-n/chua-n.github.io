...
![](../../resources/images/notebooks/Python/37.png)

然而，重要的是，后一种创建方法会使得“同时赋值”，最终子列表互相之间完全相同！！

![](../../resources/images/notebooks/Python/38.png)
...
- `dict()`函数可以直接从键值对序列里创建字典
    ...
    ![](../../resources/images/notebooks/Python/39.png)

- **字典推导式**可以从任意的键值表达式中创建字典

    ![](../../resources/images/notebooks/Python/40.png)

    <img src="../../resources/images/notebooks/Python/49.png" style="zoom:80%;" />

    > 虽然大多数情况下字典推导能做到的，通过创建一个元组序列然后把它传给`dict()`函数也能实现，但是字典推导方式表意更清晰，且实际运行也更快些：
    >
    > ![](../../resources/images/notebooks/Python/50.png)

- 当关键字是简单字符串时，通过直接关键字参数来指定键值对更方便：

    ![](../../resources/images/notebooks/Python/41.png)
...
![](../../resources/images/notebooks/Python/42.png)

### 字典的运算

以一个字典为例：

![](../../resources/images/notebooks/Python/43.png)

- 如果在一个字典上执行普通的数学运算，你会发现它们仅仅作用于键，而不是值 :

    ![](../../resources/images/notebooks/Python/44.png)

- 若想对值进行操作的同时知道对应的键的信息，当然可以在`min()`和`max()`函数中提供`key`函数参数来提取对应键的信息

    ![](../../resources/images/notebooks/Python/45.png)

- 对字典值执行计算操作——使用`zip()`函数先将键和值反转过来：

    ![](../../resources/images/notebooks/Python/46.png)

- 使用`zip()`和`sorted()`函数来排列字典数据：

    ![](../../resources/images/notebooks/Python/47.png)

为了寻找两个字典的相同点，可以简单的在两字典的`keys()`或者`items()`方法的返回结果上执行集合操作（一个字典就是一个键集合与值集合的映射关系）：

![](../../resources/images/notebooks/Python/48.png)
...
- 推导式形式：
    ...
    ![](../../resources/images/notebooks/Python/51.png)
...
![](../../resources/images/notebooks/Python/52.png)
...
|                         示例                         |                            具体值                            |
| :--------------------------------------------------: | :----------------------------------------------------------: |
| ![](../../resources/images/notebooks/Python/113.png) |     ![](../../resources/images/notebooks/Python/114.png)     |
| ![](../../resources/images/notebooks/Python/115.png) |     ![](../../resources/images/notebooks/Python/116.png)     |
| ![](../../resources/images/notebooks/Python/117.png) |     ![](../../resources/images/notebooks/Python/118.png)     |
| ![](../../resources/images/notebooks/Python/119.png) | 有时候你可能只想解压一部分而丢弃其他的值，这时候可以使用任意变量名去占位，到时候丢掉这些变量就行了。 |
...
1. `*` 操作符可从列表或元组中解包参数，而 `**` 操作符则可解包字典来得到关键字参数：
    ...
    | ![](../../resources/images/notebooks/Python/120.png) | ![](../../resources/images/notebooks/Python/121.png) |
    | :--------------------------------------------------: | :--------------------------------------------------: |
...
2. 值得注意的是\*解压出来的 phone_numbers 变量永远都是**列表类型**，即使为空列表：
    ...
    |                         示例                         |                        说明                        |
    | :--------------------------------------------------: | :------------------------------------------------: |
    | ![](../../resources/images/notebooks/Python/122.png) | phone_numbers 变量永远都是列表类型，即使为空列表。 |
    | ![](../../resources/images/notebooks/Python/123.png) |              \*表达式也可用在开始部分              |
...
![](../../resources/images/notebooks/Python/124.png)

![](../../resources/images/notebooks/Python/125.png)
...
1. 简单情况可使用“**列表推导**”或“**生成器表达式**”（生成器表达式非常节省内存）
    ...
    |                         示例                         |       说明       |
    | :--------------------------------------------------: | :--------------: |
    | ![](../../resources/images/notebooks/Python/126.png) |   使用列表推导   |
    | ![](../../resources/images/notebooks/Python/127.png) | 使用生成器表达式 |
...
| ![](../../resources/images/notebooks/Python/128.png) | ![](../../resources/images/notebooks/Python/129.png) |
| :--------------------------------------------------: | :--------------------------------------------------: |
