...
- 输入流——输入流使用**隐式的记录指针**来表示当前正准备从哪个“水滴”开始读取，每当程序从输入流中取出一个或多个“水滴”后，记录指针自动向后移动；
    ...
    ![43](https://chua-n.gitee.io/blog-images/notebooks/Java/43.jpg)

- 输出流——输出流同样采样**隐式的记录指针**来标识当前水滴即将放入的位置，每当程序向输出流里输出一个或多个水滴后，记录指针自动向后移动。

    ![44](https://chua-n.gitee.io/blog-images/notebooks/Java/44.jpg)

## 2. Java的处理流模型

Java的**处理流模型**则体现了Java输入/输出流设计的灵活性，处理流的功能主要体现在：

<img src="https://chua-n.gitee.io/blog-images/notebooks/Java/45.jpg" alt="45" style="zoom:80%;" />
...
| void  unread(int b)                             | 将一个字节/字符推回到推回缓冲区里，从崦允许重复读取刚刚读取的内容 |
...
![46](https://chua-n.gitee.io/blog-images/notebooks/Java/46.png)
