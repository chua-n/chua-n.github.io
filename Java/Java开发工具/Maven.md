...
![Maven 内置插件目标](../../resources/images/notebook/Java/142H4N00-0.png)
...
![依赖传递](../../resources/images/notebook/Java/1212441G0-0.png)
...
- 在 pom.xml 中声明的 profile，由于其能够随着 pom.xml 一起存在，它被提交到代码仓库中，被 Maven 安装到本地仓库或远程仓库中，所以它能够修改或增加很多 POM 元素，其中其常操作的元素如下表：
  ...
  <img src="../../resources/images/notebook/Java/image-20221203085844029.png" alt="image-20221203085844029" style="zoom:50%;" />
...
详见 [Maven POM | 菜鸟教程 (runoob.com)](https://www.runoob.com/maven/maven-pom.html)
